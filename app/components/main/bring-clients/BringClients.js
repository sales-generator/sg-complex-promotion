...
class BringClients extends React.Component{
    ...
    btnSubmitHandler(e) {
        ...
        roistatGoal.reach({name: formData.name, phone: formData.phone, email: '', leadName: 'Лендинг_Комплексное_продвижение', text: 'Лендинг КП - получить персональное предложение'});
